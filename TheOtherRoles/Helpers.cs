...
namespace TheOtherRoles {
    ...
    public static class Helpers
    {
        ...
        /// <returns>true:その他陣営である false:その他陣営ではない</returns>
        ...
        /// </summary>
        /// <param name="player"></param>
        /// <returns>true:フェイクタスクあり、false:フェイクタスクなし</returns>
        ...
        /// タスクがあるその他陣営かどうか
        /// </summary>
        /// <param name="player">true:タスクのあるその他陣営である false:タスクのあるその他陣営ではない</param>
        /// <returns></returns>
        ...
        public static bool isAkujoHonmei(this PlayerControl player)
        {
            return player != null &&
                (player.isRole(RoleType.Akujo) || player.hasModifier(ModifierType.AkujoHonmei));
        }
