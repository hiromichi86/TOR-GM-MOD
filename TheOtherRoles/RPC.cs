...
namespace TheOtherRoles
{
    ...
    public static class RPCProcedure
    {
        ...
        /// シフターのシフト処理
        /// </summary>
        /// <param name="targetId">シフト対象プレイヤーID</param>
        ...
        /// <param name="dyingTargetId"></param>
        /// <param name="guessedTargetId"></param>
        /// <param name="guessedRoleId"></param>
        ...
        /// 悪女の本命作成処理
        /// </summary>
        /// <param name="akujoId">悪女プレイヤーID</param>
        /// <param name="targetId">ターゲットプレイヤーID</param>
        ...
        /// 悪女の自殺処理
        /// </summary>
        /// <param name="akujoId">悪女のプレイヤーID</param>
